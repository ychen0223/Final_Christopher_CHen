...
HD_PWD='/home/chris/FInal_Project/FInal_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pmod_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pmod_LED.tcl -notrace
